...
export function Navigation({
  ...
  return (
    <>
      ...
      <div
        className="w-full md:w-md lg:w-lg  relative inline-block text-main-700 font-semibold pt-4 md:pt-0"
        onMouseEnter={() => setIsHoveringWholeBar(true)}
        onMouseLeave={() => setIsHoveringWholeBar(false)}
      >
        <div className="flex flex-row items-start md:items-center h-fit md:h-16">
          ...
          >
            <div className="w-1/3">
              ...
              <NavigationBigField
                ...
                setIsHovering={(param: boolean) => setIsHoveringDropdown(param)}
              ></NavigationBigField>
              {/* {hoveringOn === "articles" ? (
                <Link
                  className="flex flex-col space-y-4 items-center "
