  ...
  return (
    <>
      <Link
        ...
        className={cn(
          "rounded-b-xl border-b-2 px-4 lg:px-8 py-2 h-full flex flex-row space-x-2 items-center text-lg font-semibold",
          pathname===navItem.href
            ? "bg-main-700 text-white hover:bg-opacity-90 shadow-xl border-main-700"
